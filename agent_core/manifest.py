...
def default_agent_core_capabilities() -> tuple[AgentCoreCapability, ...]:
    ...
    return (
        ...
        AgentCoreCapability(
            ...
            layer="eval",
            status="stable_contract",
            summary="Aggregate SDK validation suite for readiness, API, run, context, approval, orchestration, coordination, events, provider, storage, recovery, and resume gates.",
