...
def _context_acceptance_trace_spec() -> TraceEvalSpec:
    return TraceEvalSpec(
        ...
        required_prompt_bucket_budget_roles=(),
        required_prompt_bucket_budget_statuses=(),
        max_prompt_bucket_budget_trimmed=None,
        ...
        max_prompt_semantic_trim_final_bytes=1600,
        ...
        required_context_injection_targets=("timeline_open", "semi_dynamic_2"),
