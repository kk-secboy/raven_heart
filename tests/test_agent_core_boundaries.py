...
def test_agent_core_sdk_manifest_declares_capabilities_and_runtime_boundary() -> None:
    ...
    assert "capability_governance_acceptance_harness" in capability_names
...
def test_agent_core_replacement_readiness_profile_passes_current_sdk_manifest() -> None:
    ...
    assert "capability_governance_acceptance_harness" in manifest["matched"]["capabilities"]
    ...
    assert "task_contract_profile" in manifest["matched"]["capabilities"]
